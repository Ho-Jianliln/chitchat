...
<html lang="zh-CN">
    ...
    <body>
        <h1 style="text-align: center;">ChitChat注册</h1>
        ...
        <div style="text-align: center;">
            ...
            <input type="text" name="name" id="name" class="form" placeholder="至少1位至多16位">
        </div>
        <div style="text-align: center;">
        ...
        <div style="text-align: center;">
            <input type="button" value="注册" id="register" onclick="register()">
        </div>
    </body>
    <script>
        var email;
        ...
        function sendEmailCode() {
            var data={email:$("#email").val(),method:"sendRegisterEmail"}
        ...
        function submit() {
            var data={account:$("#account").val(),password:$("#password2").val(),email:email,
                vcodecheck:$("#vcodecheck").val(),emailCode:$("#emailCode").val(),name:$("#name").val(),method:"register"}
            $.post("FrontServlet",data,function (data){
                alert(String(data));
                refreshVcode();
            });
